    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a style = "color: white;" class="dropdown-toggle" data-toggle="dropdown" href="#" onMouseOver="this.style.backgroundColor='black'" onMouseOut="this.style.backgroundColor=''"><i class="fa fa-user-o">&nbsp;<?php echo  $_SESSION['legalentityName']; ?></i><span class="caret"></span></a>
	    <ul class="dropdown-menu">
	        ...
	        <li><a href="legalentitylUploadAutoDocs.php" onMouseOver="this.style.color='red'" onMouseOut="this.style.color=''">Запис на документи на МПС</a></li>
...
<div align = "center">
    <h3 style = "margin-top: 7.0vw;">Актуализиране на документи на МПС:</h3><br>
...
<div align = "center">
    <h4 style = "">Регистрационен номер на МПС</h4>
      <form name="input" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" accept-charset="UTF-8" style = "color: black;">  
        ...
        <input type="submit"  name="btnFillData" value="Покажи редакция на документи на МПС" style = "border-radius: 2px; color: red;">
      </form>    
    <br><br>
</div>
