...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $btnShowData) {
    ...
    $con = connectServer();
        ...
        $sql = "SELECT AutosID FROM autos WHERE Reg_Number='$_SESSION[Reg_Number]' AND Admin_Username = '$_SESSION[adminUsername]'";
...
//	  }
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST" && $btnUpdate) {
      ...
      $con = connectServer();
        ...
        Where Repair_ID = '$_POST[Repair_ID]' AND Admin_Username = '$_SESSION[adminUsername]'";
