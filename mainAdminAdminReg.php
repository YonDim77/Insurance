...
<div align = "center">
  <h3 style = "margin-top: 7.0vw;">Запис на данни на подаминистратор</h3>
...
//  $hashed_password = password_hash($password, PASSWORD_DEFAULT);
  ...
  if(strcmp($password, $checkPassword) != 0) {
    ...
    $sql="INSERT INTO admin (fName, lName, Email, username, password)
    VALUES
    ('$_POST[Ime]', '$_POST[Familia]', '$_POST[Email]', '$_POST[Username]','$password')";
