...
<div align = "center">
  ...
  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" accept-charset="UTF-8" style = ""> 
	...
	<p style = "margin-bottom: 0px;">Рег. №*</p><input type="text" name="Reg_Number" value = "<?php if(isset($_SESSION['Reg_Number'])) echo $_SESSION['Reg_Number']; else echo $Reg_Number;?>" style = "width:174px;" required="required" placeholder = "Задължително попълване">
	<br><br>
  ...
  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" accept-charset="UTF-8" style = "">  
    ...
    <input type="text" name="Reg_Num" value = "<?php if(isset($_SESSION['Reg_Number'])) echo $_SESSION['Reg_Number']; else echo $Reg_Number;?>" style = "display: none;">
    <table class = "iDataInput">
        ...
        <tr>
            <td>Цена*<br><input type="text" value="<?php echo $Price;?>" name="Price" style = "width:174px; height: 27px;" required="required" placeholder = "Задължително попълване"></td>
