...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $btnShowData) {
    ...
    $con = connectServer();
        ...
        $sql = "SELECT AutosID FROM autos WHERE Reg_Number='$_SESSION[Reg_NumberLocalS]'";
    ...
    $con = connectServer();
		...
		$checkForServiceId = mysqli_query($con, "SELECT *FROM service WHERE Service_ID = '$Service_ID' AND AutosID = '$_SESSION[Autos_ID]'");
...
//	  }
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST" && $btnUpdate) {
        ...
        $resultHistory = mysqli_query($con, "SELECT * FROM service Where Service_ID = '$_POST[Service_ID]'");
      ...
      $sqlShowUpdatedData = mysqli_query($con, "SELECT * FROM service WHERE Service_ID = '$_POST[Service_ID]'");
...
<div align = "center">
  ...
  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" accept-charset="UTF-8" style = ""> 
	...
	<p style = "margin-bottom: 0px;">Рег. №*</p><input type="text" name="Reg_Number" value = "<?php if(isset($_SESSION['Reg_Number'])) echo $_SESSION['Reg_Number']; else echo $_SESSION['Reg_NumberLocalS'];?>" style = "width:174px;" required="required" placeholder = "Задължително попълване">
	<br><br>
  ...
  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" accept-charset="UTF-8" style = ""> 
    <table class = "iDataInput">
        <tr>
            ...
            <td>Обслужване на*<br>
            <select id = "tEntity" name="Type" style = "width:174px; height: 27px;" required="required" onchange = "toggleEnable()">
