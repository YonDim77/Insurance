...
if (($_SERVER["REQUEST_METHOD"] == "POST" || $btnShowData == true) && $btnShowDataAuto == false && $btnUploadDataAuto == false) {
	...
	$result = mysqli_query($con, "SELECT * FROM legalentity WHERE Name LIKE '$Name%' AND Admin_Username = '$_SESSION[adminUsername]'"); 
	$resultEik = mysqli_query($con, "SELECT * FROM legalentity WHERE EIK = '$_POST[EIK]' AND Admin_Username = '$_SESSION[adminUsername]'");
