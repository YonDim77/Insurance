...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $btnShowData) {
    ...
    $con = connectServer();
        ...
        $sql = "SELECT AutosID FROM autos WHERE Reg_Number='$_SESSION[Reg_NumberLocalS]' AND Sub_Admin_Username = '$_SESSION[subAdminUsername]'";
...
//	  }
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST" && $btnUpdate) {
        ...
        $resultHistory = mysqli_query($con, "SELECT * FROM service Where Service_ID = '$_POST[Service_ID]' AND Sub_Admin_Username = '$_SESSION[subAdminUsername]'");
        if(strcmp($_POST['Type'], 'масла и филтри') != 0) {
            ...
            Where Service_ID = '$_POST[Service_ID]' AND Sub_Admin_Username = '$_SESSION[subAdminUsername]'";
      ...
      $sqlShowUpdatedData = mysqli_query($con, "SELECT * FROM service WHERE Service_ID = '$_POST[Service_ID]' AND Sub_Admin_Username = '$_SESSION[subAdminUsername]'");
