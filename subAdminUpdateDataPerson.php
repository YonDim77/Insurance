...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $btnFillData) {
    ...
    $Individual_ID = $_POST["Individual_ID"];
    	...
    	
      {
        ...
        $sql = "SELECT Individual_ID FROM individual WHERE Individual_ID='$url_id' AND Sub_Admin_Username = '".$subAdminUsername."'";
        ...
        $result = mysqli_query($con, "SELECT * FROM individual WHERE Individual_ID='$url_id' AND Sub_Admin_Username = '".$subAdminUsername."'");
    	if (!$result) {
  ...
  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" accept-charset="UTF-8" style = "">  
    <table class = "iDataInput">
        <tr>
            ...
            <!--<td>Избери потребител*<br><input type="email" name="Sub_Admin_Username" value = "<?php echo $Sub_Admin_Username;?>"></td>-->
