...
if (($_SERVER["REQUEST_METHOD"] == "POST" || $btnShowData == true) && $btnShowDataAuto == false) {
	...
	$result = mysqli_query($con, "SELECT * FROM individual WHERE Names LIKE '$Names%' AND Admin_Username = '".$adminUsername."'"); 
	$resultEgn = mysqli_query($con, "SELECT * FROM individual WHERE EGN = '$_POST[EGN]' AND Admin_Username = '".$adminUsername."'");
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $btnShowDataForm == true) {
	...
	$resultPerson = mysqli_query($con, "SELECT * FROM individual WHERE Individual_ID = '$Individual_ID' AND Admin_Username = '".$adminUsername."'");
	$resultPersonName = mysqli_query($con, "SELECT Names FROM individual WHERE Individual_ID = '$Individual_ID' AND Admin_Username = '".$adminUsername."'");
