...
<br>
<div align = "center">
    <h3 style = "margin-top: 7.0vw; text-align: center;">Данни за всички юридически лица:</h3>
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $btnDisplayData) {
    ...
    */
        $result = mysqli_query($con, "SELECT * FROM legalentity WHERE Sub_Admin_Username = '$_SESSION[subAdminUsername]'");
