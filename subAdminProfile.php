...
$password = ""; 
    ...
    $con = connectServer();
        ...
        $sql = "SELECT * FROM subadmin WHERE username = '$_SESSION[subAdminUsername]'";
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST" && $btnUpdate) {
      ...
      if(strcmp($password, $checkPassword) != 0) {
        ...
        $sqlUpdateMainAdmin="UPDATE subadmin SET fName = '$_POST[fName]', lName = '$_POST[lName]', 
        ...
        //  mysqli_query($con1,"COMMIT");
          ...
          mysqli_commit($con1);
          $_SESSION['subAdminfName'] = $_POST['fName'];
          $_SESSION['subAdminlName'] = $_POST['lName'];
          $message = "Данните са актуализирани успешно!";
          echo "<script>alert('$message');</script>";
          echo "<script> location.replace('subAdminProfile.php'); </script>"; 
...
<div align = "center">
  ...
  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" accept-charset="UTF-8" style = "">  
	...
	<table class = "iDataInput">
        ...
        <tr>
	        <td>Имейл като<br>потребителско име*<br><input type="email" name="username" value = "<?php echo $saveUsername; ?>" required="required" placeholder = "Задължително попълване" readonly></td>
