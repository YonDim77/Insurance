...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $btnFillData) {
    ...
    $Individual_ID = $_POST["Individual_ID"];
    	...
    	
      {
        ...
        $sql = "SELECT Individual_ID FROM individual WHERE Individual_ID='$url_id'";
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST" && $btnUpdate) {
      ...
      if(strcmp($password, $checkPassword) != 0) {
        ...
        $sqlUpdateIndividual="UPDATE individual SET  
...
<div align = "center">
  ...
  <h3 style = "margin-top: 100px;">Актуализиране данни на физическо лице:</h3>
  <br>
  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" accept-charset="UTF-8"> 
    <p id="demo" style = "margin-bottom: 0px;">ID/№ на физическо лице*</p><input id = "numRec" oninput="checkInput()" type="number" name="Individual_ID" value = "<?php echo $Individual_ID;?>" required="required" placeholder = "Задължително попълване">
	<br><br>
  ...
  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" accept-charset="UTF-8"> 
    <table class = "iDataInput">
        ...
        <tr>
	        ...
	        <td>@-л на лице за контакти*<br><input type="email" name="Email_Contact_Person" value = "<?php echo $Email_Contact_Person;?>" required="required" placeholder = "Задължително попълване"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td></td>
            <td>Парола потвърждаване*<br><input type="password" name="checkPassword" value = "<?php echo $Password;?>" required="required" placeholder = "Задължително попълване"></td>
        </tr>
        <tr>
            <td></td>
