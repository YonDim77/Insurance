...
<div align = "center">
    <h3 style = "margin-top: 7.0vw; text-align: center;">Данни за всички физически лица, които са към <?php echo $_POST['Admin_Username']; echo $_POST['Sub_Admin_Username'];?></h3>
    <br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $btnDisplayData) {
    ...
    if((strlen($admin) == 0 && strlen($subAdmin) == 0) || (strlen($admin) > 0 && strlen($subAdmin) > 0)) {
        ...
        $result = mysqli_query($con, "SELECT * FROM individual WHERE Admin_Username = '$_POST[Admin_Username]' OR Sub_Admin_Username = '$_POST[Sub_Admin_Username]'");
