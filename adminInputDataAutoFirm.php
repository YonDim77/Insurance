...
<br>
  ...
  <button onclick = "location.href='adminInputDataTyresAutoFirm.php'" style = "width: 32%; border-radius: 2px; color: red;">Въвеждане на данни за ремонти и гуми на МПС</button>
  <br><br>
...
//  $idCheck = mysqli_query($con2, "SELECT * FROM individual WHERE Individual_ID = $_POST[Individual_ID]");
  ...
  else
  {
    ...
    $message = "Данните са записани успешно!";
	echo "<script>alert('$message');</script>";
	echo "<script> location.replace('adminInputDataTyresAutoFirm.php'); </script>";
  }
  mysqli_query($con2, "SET AUTOCOMMIT=TRUE");
