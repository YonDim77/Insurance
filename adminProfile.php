...
$password = ""; 
    ...
    $con = connectServer();
        ...
        $sql = "SELECT * FROM admin WHERE username = '$_SESSION[adminUsername]'";
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST" && $btnUpdate) {
      ...
      if(strcmp($password, $checkPassword) != 0) {
        ...
        $sqlUpdateMainAdmin="UPDATE admin SET fName = '$_POST[fName]', lName = '$_POST[lName]', 
        ...
        //  mysqli_query($con1,"COMMIT");
          ...
          mysqli_commit($con1);
          $_SESSION['adminfName'] = $_POST['fName'];
          $_SESSION['adminlName'] = $_POST['lName'];
          $message = "Данните са актуализирани успешно!";
          echo "<script>alert('$message');</script>";
          echo "<script> location.replace('adminProfile.php'); </script>"; 
