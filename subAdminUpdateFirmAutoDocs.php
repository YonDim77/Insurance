...
<div align = "center">
    <h3 style = "margin-top: 7.0vw;">Актуализиране на документи на МПС на юридическо лице:</h3><br>
    ...
    if (($_SERVER["REQUEST_METHOD"] == "POST" || $btnShowData == true) && ($btnFillData == false && $btnUpdatePdf == false)) {
    	...
    	{				  
    	    if (mysqli_num_rows($result) < 1) {
    	    	...
    	    	$message = "Няма " . $Name . " в базата данни или нямате достъп!";
    	    	echo "<script>alert('$message');</script>";
    	    }
    	    ...
    	    if (mysqli_num_rows($resultEik) < 1) {
    	    	...
    	    	$message = "Няма фирма с ЕИК: " . $_SESSION['Eik'] . " в базата данни или нямате достъп!";
    	    	echo "<script>alert('$message');</script>";
    	    }
    	    ...
    	    '<span id = "egn" style="font-size: 20px; color:' . $Color . '">' . $_SESSION['Eik'] . '</span>';
    	    echo"</div>";
            echo"<br><br>";
