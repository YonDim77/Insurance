...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $btnFillData) {
    ...
    $ID = $_POST["ID"];
    	...
    	
      {
        ...
        $sql = "SELECT HoldingUsers_ID FROM holdingusers WHERE HoldingUsers_ID='$url_id' AND Admin_Username = '$_SESSION[adminUsername]'";
        ...
        $result = mysqli_query($con, "SELECT * FROM holdingusers
									  WHERE HoldingUsers_ID = '$_POST[ID]' AND Admin_Username = '$_SESSION[adminUsername]'");
    	if (!$result) {
