...
//   $hashed_password = password_hash($Password, PASSWORD_DEFAULT);
  ...
  //else {
    ...
    VALUES
    ('$_POST[Admin_Username]', '$_POST[Sub_Admin_Username]', '$_POST[Ime]')";
  ...
  <form name="input" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" accept-charset="UTF-8" style = "">
    <table class = "iDataInput"> 
        <tr>
            ...
            <td>Избери холдинг*<br><select style = "width: 174px; height: 27px;" name="Holding_Name" onchange="showAdmin(this.value), showSubAdmin1(this.value)" required="required" placeholder = "Задължително попълване"/>
        ...
        <tr>  
            <td><br>Потребителско име*<br><input type="email" name="Username" required="required" placeholder = "Задължително попълване"></td>
...
//   $hashed_password = password_hash($Password, PASSWORD_DEFAULT);
  ...
  if(strcmp($password, $checkPassword) != 0) {
    ...
    VALUES
    ('$_POST[Holding_Name]', '$_POST[Admin_Username]', '$_POST[Sub_Admin_Username]', '$_POST[fName]', '$_POST[lName]', '$_POST[Telephone]', '$_POST[Username]', '$password')";
    //('$_POST[Admin_Username]', '$_POST[Sub_Admin_Username]', '$_POST[Ime]', '$_POST[Username]', '$password')";
    //('$_POST[Admin_Username]', '$_POST[Ime]', '$_POST[Familia]', '$_POST[Email]', '$_POST[Username]','$hashed_password')";
    ...
    if($last_id > 0) {
        ...
        <th bgcolor='$color1'>$h2 Подадминистратор</th>
