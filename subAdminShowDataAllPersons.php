...
<!--      <a id = "brandMenu" class="navbar-brand" href="#" style = "color:red;">Буболечкоубийци</a>-->
    ...
    <ul class="nav navbar-nav">
      <li id = "listHome" style = "margin-top: 3px;"><a href="homeAdmin.php" onMouseOver="this.style.backgroundColor='black'" onMouseOut="this.style.backgroundColor=''"><i class="fa fa-home">Начало</i></a></li>
...
<!--	      <li id = "sprayer" style = "background-color: white; color: white; margin-top:0px;">AAAA<img src="Sprayer.jpg" alt="BugKillers" width="60" height="50" style = "border-radius: 5px;"></li>-->
          <li><a href="adminInputDataPerson.php" onMouseOver="this.style.color='red'" onMouseOut="this.style.color=''">Запис на данни за физическо лице</a></li>
		  ...
		  <li><a href="adminShowDataPerson.php" onMouseOver="this.style.color='red'" onMouseOut="this.style.color=''">Визуализиране данни на физическо лице</a></li>
          ...
          <li><a href="eraseData.php" onMouseOver="this.style.color='red'" onMouseOut="this.style.color=''">Изтриване на данни по зададен номер</a></li>
      ...
      <li id = "listGallery"><a href="adminShowDataAllPersons.php" onMouseOver="this.style.backgroundColor='black'" onMouseOut="this.style.backgroundColor=''">Извеждане на данни за всички физически лица</a></li>
...
$result = mysqli_query($con, "SELECT * FROM individual WHERE Sub_Admin_Username = '".$subAdminUsername."'");
