                        ...
                        while($row = mysqli_fetch_array($sqlResult))
                          {
                            ...
                            echo "<tr>";
                            echo "<td style = 'border: 1px solid black; color: black;'>" . $row['Service_ID'] . "</td>";	
                            echo "<td style = 'border: 1px solid black; color: black;'>" . $row['AutosID'] . "</td>";
                            ...
                            echo "<td style = 'border: 1px solid black; color: black;'>" . $row['Service'] . "</td>";
                            //echo "<td style = 'border: 1px solid black; color: white;'>" . date_format($ofDate,"d-m-Y") . "</td>";
                            //echo "<td style = 'border: 1px solid black; color: white;'>" . date_format($oftDate,"d-m-Y") . "</td>";
