...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $btnFillData) {
    ...
    $Legalentity_ID = $_POST["Legalentity_ID"];
    	...
    	
      {
        ...
        $sql = "SELECT Legalentity_ID FROM legalentity WHERE Legalentity_ID='$url_id' AND Admin_Username = '".$adminUsername."'";
        ...
        $result = mysqli_query($con, "SELECT * FROM legalentity
    	                      WHERE Legalentity_ID = '$_POST[Legalentity_ID]' AND Admin_Username = '".$adminUsername."'");
    	if (!$result) {
