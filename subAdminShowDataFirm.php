...
if (($_SERVER["REQUEST_METHOD"] == "POST" || $btnShowData == true) && $btnShowDataAuto == false) {
	...
	$result = mysqli_query($con, "SELECT * FROM legalentity WHERE Name LIKE '$Name%' AND Sub_Admin_Username = '".$subAdminUsername."'"); 
	$resultEik = mysqli_query($con, "SELECT * FROM legalentity WHERE EIK = '$_POST[EIK]' AND Sub_Admin_Username = '".$subAdminUsername."'");
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $btnShowDataForm == true) {
	...
	$resultFirm = mysqli_query($con, "SELECT * FROM legalentity WHERE Legalentity_ID = '$Legalentity_ID' AND Sub_Admin_Username = '".$subAdminUsername."'");
	$resultFirmName = mysqli_query($con, "SELECT Name FROM legalentity WHERE Legalentity_ID = '$Legalentity_ID' AND Sub_Admin_Username = '".$subAdminUsername."'");
