...
echo "<br><br>";
echo"<h3 style = 'margin-top: 4.0vw;'>Списък с потребители:</h3>";
...
?>
  ...
  <h3 style = "margin-top: 4.0vw;">Запис на данни за юридическо лице</h3>
...
<br><br>
  ...
  <button onclick = "location.href='adminInputDataAutoFirm.php'" style = "width: 27%; border-radius: 2px; color: red;">Въвеждане данни за застраховки и сервиз на МПС</button>
  <br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && $btnSaveAuto == true) {
  ...
  VALUES
  ('$Individual_ID', '$_POST[Legalentity_ID]', '$_POST[Admin_Username]', '$_POST[Sub_Admin_Username]', '$_POST[Type]', '$_POST[Brand]','$_POST[Model]', '$_POST[RegNumber]', '$_POST[Kupe]', 
  ...
  else
  {
    ...
    $message = "Данните са записани успешно!";
	echo "<script>alert('$message');</script>";
	echo "<script> location.replace('adminInputDataAutoFirm.php'); </script>";
  }
